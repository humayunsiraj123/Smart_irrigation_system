...
int event_day[4][4][15]={
                      {{15,37,97,129,151,169,185,199,212,229},
                       {27,111,150,177,199,220},
                       {13,29,62,107,133,151,168,183,195,208,221},
                       {19,59,117,148,170,190,206,224},},

                        {{5,11,18,33,60,96,115},
                       {9,24,63,106},
                       ...
                       {{98, 131, 153, 171, 188, 202, 215,228, 243, 337},
                       {116, 153,180, 202, 223, 224,364},
                       {95, 126, 147, 164, 179, 193, 205, 218, 229, 243, 333},
                       {107, 143 , 165, 186, 203,  220, 238, 348},}
                       };
//3d array index [crop][soil][water_level_in mm] 
int event_level[4][4][15]={ 
                        {{3,4,8,10,11,12,12,12,12,12},
                        {6,13,17,18,18,18},
                        {3,4,5,8,9,10,11,11,11,11,11},
                        {4,7,11,13,15,15,15,15},},
...
//
if(((millis()-time)>86400000)&&(soil_flag==1 && crop_flag==1)){
//
...
//
 ...
 if(s1>650 | s1<200  |s2>650 |s2<200)
 {
 backup=1;
 //tft_backup[7]=1;
...
//// //flow meter volume
//
volume = (2.66*pulse)/1000000;/////2.66 calibration factor and div by 1000 for mmm
